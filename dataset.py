...
class STDataset(Dataset):
    ...
    '''
    def __init__(self,student_dir,teacher_dir,transform = None):
        assert len(os.listdir(student_dir)) == len(os.listdir(teacher_dir)), "numbers of img and label dismatch."
        self.img_dir = student_dir
        self.mask_dir = teacher_dir
        self.img_list = [i for i in os.listdir(student_dir)]
